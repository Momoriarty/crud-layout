...
if ($module == 'user' and $act == 'insert'):
    ...
    if ($result_check_username->num_rows > 0) {
        ...
        exit();        // Atau lakukan tindakan lain seperti pengalihan atau pengiriman pesan kesalahan
    } elseif ($result_check_nama->num_rows > 0) {
...
elseif ($module == 'user' and $act == 'delete'):
    ...
    //query hapus
    $query = "DELETE FROM `muda_user` WHERE `muda_user`.`id` = '$id'";
